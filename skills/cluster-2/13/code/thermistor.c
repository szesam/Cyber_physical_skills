// Thermistor resistance around 9.3kohm
//Standard Library
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
float T; // temperature converted using steinhart-Hart equation
...
static void adc_task()
{
    ...
    while (1) {
        ...
        float R2 = 10000 * (3300/(float)voltage -1);
        // convert resistance in thermistor to temperature.
        float logR2 = log(R2);
...
static void i2c_task()
{
    ...
    while(1)
    {
        ...
        displaybuffer[3] = alphafonttable[(int)T%10 + '0'];
        displaybuffer[2] = alphafonttable[(int)(T/10)%10 + '0'];
        displaybuffer[1] = alphafonttable[(int)(T/100)%10 + '0'];
        displaybuffer[0] = alphafonttable[(int)(T/1000)%10 + '0'];
